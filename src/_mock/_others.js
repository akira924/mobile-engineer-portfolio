...
export const _testimonials = [
  {
    ...
    content: `Ivan ramped up quickly on our diabetes prevention app and shipped a solid Expo EAS pipeline. Release cadence is smoother and the native bridges held up well through our architecture migration.`,
  },
  {
    name: 'Priya Nair',
    ...
    content: `Strong React Native instincts on a fast-moving betting product. Real-time feeds and gesture-heavy screens were noticeably snappier after his performance pass. Would have liked a bit more upfront documentation on the GraphQL layer.`,
  },
  {
    name: 'Marcus Lien',
    ...
    content: `Rare engineer who can own mobile, APIs, and integrations end to end. Biometric auth and offline sync shipped on time, and his Node.js backends were clean enough for the team to extend without hand-holding.`,
  },
  {
    name: 'Rachel Kim',
    postedDate: '2020-03-22',
    ratingNumber: 4,
    avatarUrl: _mock.image.avatar(4),
    content: `Led our React Native migration with patience and good judgment. Firebase order tracking was reliable, though a few legacy modules took longer to unwind than we first estimated.`,
  },
  {
    name: 'Alex Turner',
    postedDate: '2017-11-08',
    ratingNumber: 5,
    avatarUrl: _mock.image.avatar(5),
    content: `Dependable on trading flows and market data at Robinhood. Low-latency WebSocket work was thoughtful, and he handled Objective-C and Swift transitions without slowing the squad down.`,
  },
  {
    name: 'Greg Sullivan',
    postedDate: '2014-09-15',
    ratingNumber: 4,
    avatarUrl: _mock.image.avatar(6),
    content: `Hired Ivan on Upwork for a client ordering portal and Stripe checkout. Responsive communicator, shipped on budget, and the responsive UI held up well on older Android devices.`,
  },
];
